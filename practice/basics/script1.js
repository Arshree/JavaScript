...
// let print1 = callBack("hello");

// console.log(print1);

//let arr = ["pune", "delhi", "mumbai", "hydrabad"];
// let state = [""]
...
// print the sqaure of each arr no
...
// arr.forEach((val, idx, arr) =>{
//     let square = val*val; //val**2
//     console.log(`square of the ${arr[idx]} is ${square}` );
// })
...
//     return res > val ? res : val; // maximun no
//     //return res + val //add all array
// })

// console.log(result);

// let marks = [45, 67,90, 98, 95, 35, 97];

// let morethenNinty = marks.filter((val) =>{
//         return val > 90;
// });

// console.log(morethenNinty);

// let n = prompt("Enter your no");
// let arr = [];
//let arr[0] = 1;

// let sum1 = newArray((arr) =>{
    // for(let i=1; i<=n; i++){
    // arr[i-1] = i;
// }
// console.log(arr);
